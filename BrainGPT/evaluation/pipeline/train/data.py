...
#         print(unified_dataset)
        ...
        # Removed the RandomSampler
        if args.distributed_type == "DEEPSPEED" or args.distributed_type == "MULTI_GPU":
            sampler = DistributedProxySampler(None, num_replicas=args.world_size, rank=args.rank)  # Passed None as the original sampler
        else:
            sampler = None  # In case no sampler is needed for the DataLoader
