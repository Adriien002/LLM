export PYTHONPATH="./evaluation" # Change this path to your local path of FORTE/evaluation/ directory, where python will look for additional module. Necessary for correctly importing modules from evaluation/ 
